            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('Roles y permisos')
                        <x-jet-nav-link href="{{ route('administrador.rol.index') }}" :active="request()->routeIs('administrador')">
                            Roles
                        </x-jet-nav-link>
                    ...
                    @endcan
                    @can('Ver ordenes')
                        <x-jet-nav-link href="{{ route('cliente.perfil') }}" :active="request()->routeIs('cliente')">
                            Productos
                        </x-jet-nav-link>
                    @endcan
                </div>
